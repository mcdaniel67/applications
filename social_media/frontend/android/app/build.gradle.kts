...
// Read API URL from local.properties or use defaults
...
val debugApiUrl = localProperties.getProperty("debug.api.url") ?: "http://10.0.2.2:5000/api/"
val releaseApiUrl = localProperties.getProperty("release.api.url") ?: "https://your-production-api.com/api/"
